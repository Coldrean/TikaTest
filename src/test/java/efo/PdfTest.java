...
public class PdfTest {
    ...
    PDFParser autoParser=new PDFParser();
    ...
    public void init(){
        ...
        autoParser.setPDFParserConfig(config);
    }
    ...
    @Test
    public void testMyHandlerParsePdfWithImgs__output_imgs() throws TikaException, SAXException, IOException {
        String filename="pdf-text-with-image.pdf";
        InputStream stream =this.getClass().getClassLoader().getResourceAsStream(Paths.get(inputDir,filename).toString());
